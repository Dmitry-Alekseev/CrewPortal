...
fun SettingsScreen(
    ...
    Column(
        ...
        Card(colors = CardDefaults.cardColors(containerColor = MaterialTheme.colorScheme.surface), modifier = Modifier.fillMaxWidth()) {
            Column(Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(8.dp)) {
                Text("Change Log — 2.2.3", style = MaterialTheme.typography.titleMedium, fontWeight = FontWeight.Bold)
                ...
                Text("• Version metadata updated to 2.2.3.", color = MaterialTheme.colorScheme.onSurfaceVariant)
            }
        }
