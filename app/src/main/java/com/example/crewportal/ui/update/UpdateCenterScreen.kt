...
fun UpdateCenterScreen(
    ...
    Column(
        ...
        InfoCard(if (ru) "Журнал изменений — 2.2.3" else "Change log — 2.2.3") {
            listOf(
                ...
                if (ru) "Метаданные версии и workflow обновлены под 2.2.3." else "Version metadata and workflows updated to 2.2.3."
