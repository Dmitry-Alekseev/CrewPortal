...
fun UpdateCenterScreen(
    ...
    Column(
        ...
        InfoCard(if (ru) "Журнал изменений — 2.2.0" else "Change log — 2.2.0") {
            listOf(
                ...
                if (ru) "Метаданные версии и workflow обновлены под 2.2.0." else "Version metadata and workflows updated to 2.2.0."
